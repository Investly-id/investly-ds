...
const ReyCard = (props: SvgProps) => {
  ...
  return (
    ...
    >
      ...
      <Path
        d="M18.1832 16.3415H20.0124C20.5581 16.3415 20.9877 15.8977 20.9877 15.3662C20.9877 14.8205 20.5439 14.3909 20.0124 14.3909H18.1832C17.6375 14.3909 17.2079 14.8348 17.2079 15.3662C17.2078 15.9118 17.6517 16.3415 18.1832 16.3415Z"
        fill={fill}
      />
      <Path
